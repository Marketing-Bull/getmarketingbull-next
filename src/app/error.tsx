...
// Error boundaries must be client components; this is not a page, so the
// "no 'use client' on pages" rule does not apply.
  ...
  return (
    <section className="relative bg-slate-950 text-white overflow-hidden min-h-[70vh] flex items-center">
      ...
      <div className="container-md relative py-24 max-w-2xl text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400 mb-6">Something went wrong</p>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.05] mb-6">That didn&apos;t load.</h1>
        <p className="text-lg text-slate-300 leading-relaxed mb-10">
          Try again in a moment. If it keeps happening, call{' '}
        ...
        <p className="mt-10 text-sm text-slate-500">
          <Link href="/free-consultation" className="hover:text-slate-300">Or send us a note →</Link>
        </p>
      </div>
    </section>
  );
