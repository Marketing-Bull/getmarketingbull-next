    ...
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-start">
        ...
        <label htmlFor="smsConsent" className="text-sm text-gray-600">
          I consent to receive SMS messages from Marketing Bull about my inquiry
        </label>
      </div>
      ...
      {submitted && (
        <p className="text-green-600 font-semibold text-center">Thank you! We'll be in touch soon.</p>
      )}
    </form>
  );
}
